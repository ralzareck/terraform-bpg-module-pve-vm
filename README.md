...
| <a name="input_vm_type"></a> [vm\_type](#input\_vm\_type) | The source type used for the creation of the container. Can either be 'clone' or 'template'. | `string` | `n/a` | $\color{green}{yes}$ |
